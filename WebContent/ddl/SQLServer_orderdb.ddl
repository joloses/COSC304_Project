...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Basketball Shoes', 1, 'indoor use, provides great grip',90.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Hiking Boots',1,'Perfect in day hikes',120.00);
...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Soccer Socks',2,'Long socks used in soccer',5.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Compression Shirt',3,'in gym or atheltic use',20.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Breathable Shirt',3,'Multipurpose or perfect in running',25.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('WarmTech Long Sleeve Top',3,'Keeps you warm in winter activities',30.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Athletic Shorts',4,'Multipurpose, fit in any sport',18.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Snow Pants',4,'Perfect during ski season',60.98);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Breathable Sweatpants',4,'Will you play? Will you not? Perfect in both',30.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Wristbands',5,'To ease off the sweat',10.56);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Knee Pads',6,'Perfect in those volleyball digs',7.72);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Swim Cap',7,'Maximize your water aerodynamics', 14.49);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Athletic Tape',8,'Sold in 1 box of 4 tapes',12.27);
...
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (5, 1, 6, 2135);
...
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password) VALUES ('Arnold', 'Anderson', 'aanderson@gmailcom', '204-111-2222', '103 AnyWhere Street', 'Winnipeg', 'MB', 'R3X 45T', 'Canada', 'arnold' , '304Arnold!');
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password) VALUES ('Bobby', 'Brown', 'bobbybrown@hotmailca', '572-342-8911', '222 Bush Avenue', 'Boston', 'MA', '22222', 'United States', 'bobby' , '304Bobby!');
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password) VALUES ('Candace', 'Cole', 'cole@charityorg', '333-444-5555', '333 Central Crescent', 'Chicago', 'IL', '33333', 'United States', 'candace' , '304Candace!');
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password) VALUES ('Darren', 'Doe', 'oe@doecom', '250-807-2222', '444 Dover Lane', 'Kelowna', 'BC', 'V1V 2X9', 'Canada', 'darren' , '304Darren!');
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password) VALUES ('Elizabeth', 'Elliott', 'engel@uiowaedu', '555-666-7777', '555 Everwood Street', 'Iowa City', 'IA', '52241', 'United States', 'beth' , '304Beth!');

-- Order 1 can be shipped as have enough inventory
DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (1, '2019-10-15 10:25:55', 9170)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 1, 1, 18)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 5, 2, 2135)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 10, 1, 31);

INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (2, '2019-10-16 18:00:00', 10675)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 5, 5, 2135);

-- Order 3 cannot be shipped as do not have enough inventory in item 7
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (3, '2019-10-15 3:30:22', 140)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 6, 2, 25)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 7, 3, 30);

INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (2, '2019-10-17 05:45:11', 32785)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 3, 4, 10)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 8, 3, 40)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 13, 3, 2325)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 28, 2, 2105)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 29, 4, 14);

INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (5, '2019-10-15 10:25:55', 27740)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 5, 4, 2135)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 19, 2, 81)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 20, 3, 10);

-- New SQL DDL in lab 8
UPDATE Product SET productImageURL = 'img/1n.jpg' WHERE ProductId = 1;
UPDATE Product SET productImageURL = 'img/2n.jpg' WHERE ProductId = 2;
