...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Compression Shirt',3,'For gym or atheltic use!',20.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Breathable Shirt',3,'Multipurpose; perfect for running!',25.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('WarmTech Long Sleeve Top',3,'Keeps you warm for winter activities!',30.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Athletic Shorts',4,'Multipurpose; fit for any sport!',18.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Snow Pants',4,'Just in time for ski season!',60.98);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Breathable Sweatpants',4,'Will you play? Will you not? Perfect for both',30.99);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Wristbands',5,'To ease off the sweat!',10.56);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Knee Pads',6,'Perfect for those volleyball digs!',7.72);
